...
myPackage.scripts.prepush = "npm run test:prod && npm run build"
myPackage.scripts.commitmsg = "validate-commit-msg"

writeFileSync(
  path.resolve(__dirname, "..", "package.json"),
  JSON.stringify(myPackage, null, 2)
)
...
if (myPackage.repository.url.trim()) {
